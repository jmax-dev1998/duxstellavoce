        ...
        <div class="auth-card">
          ...
          <div class="auth-card-inner">
            <div class="auth-header">
              ...
              <h1 class="auth-title">Join Dux Stella Voce</h1>
              <p class="auth-subtitle">Create your account and stay connected</p>
            </div>
            ...
            <form @submit.prevent="handleRegister" class="auth-form" novalidate>
              ...
              <transition name="alert-slide">
                <div v-if="password && confirmPassword && password !== confirmPassword" class="auth-alert auth-alert-warning">
                  <i class="bi bi-exclamation-circle me-2"></i>
            ...
            <div class="auth-footer">
              ...
              <router-link to="/login" class="auth-switch-btn">
